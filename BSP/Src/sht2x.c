 ...
 */
void SHT2x_Init(I2C_Handle_t *hi2c) {
	_sht2x_ui2c = hi2c;
}
...
void SHT2x_SoftReset(void){
	...
	I2C_ControllerSendData(_sht2x_ui2c, &cmd, strlen(cmd), SHT2x_I2C_ADDR, ENABLE);
}
...
void SHT2x_SetResolution(SHT2x_Resolution res) {
	...
	I2C_ControllerSendData(_sht2x_ui2c, temp, 2, SHT2x_I2C_ADDR, ENABLE);
}
